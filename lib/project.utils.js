        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!fs_1.default.existsSync(manifestFile)) return [3 /*break*/, 2];
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2:
                    manifest.id = manifest.id || options.data.id;
                    manifest.name = manifest.name || options.data.name;
                    manifest.color = manifest.color || options.data.color;
    ...
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                ...
                files = file_utils_1.getFilesRecursively(projectPath);
                ...
                fapFilePath = path_1.default.resolve(projectPath, projectPath.split("/")[projectPath.split("/").length - 1] + ".fap");
                zip
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    tasks = new listr_1.default([
                        {
                            title: "Validate f.app.json",
                            task: function (context, task) { return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                                var error_3;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            _a.trys.push([0, 2, , 3]);
                                            task.output = "Validating f.app.json ...";
                                            return [4 /*yield*/, manifest_utils_1.validateManifest(path)];
                                        case 1:
                                            _a.sent();
                                            context.validManifest = true;
                                            resolve(true);
                                            return [3 /*break*/, 3];
                                        case 2:
                                            error_3 = _a.sent();
                                            context.validManifest = false;
                        ...
                        {
                            title: "Build App",
                            enabled: function (context) { return context.validManifest; },
                            task: function (context, task) { return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                                var error_4;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
