    ...
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                ...
                files = FilesHandler_1.getFilesRecursively(projectPath);
...
exports.createProject = function (options) {
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        var tasks, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.buildProject = function (path) {
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        var tasks, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    if (!exports.isDirectoryFamenunProject(path)) return [3 /*break*/, 2];
                    tasks = new listr_1.default([
                        {
                            title: "Build App",
...
exports.isDirectoryFamenunProject = function (dir) {
