...
var promptForMissingOptions = function (options) {
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!ProjectHandler_1.isDirectoryFamenunProject()) return [3 /*break*/, 4];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 9];
                case 2:
                    if (!!ProjectHandler_1.isDirectoryFamenunProject()) return [3 /*break*/, 8];
                    _b.label = 3;
                case 3:
                    _b.trys.push([3, 6, , 7]);
                ...
                case 4:
                    options = _b.sent();
                    return [4 /*yield*/, ProjectHandler_1.createProject(options)];
                case 5:
                    _b.sent();
                ...
                case 10:
                    ...
                    return [3 /*break*/, 13];
                case 11: return [4 /*yield*/, ProjectHandler_1.buildProject(process.argv[3])];
                case 12:
                    _b.sent();
                    _b.label = 13;
