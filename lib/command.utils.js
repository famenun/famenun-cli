...
var project_utils_1 = require("./project.utils");
...
var promptForMissingOptions = function (options) {
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!project_utils_1.isDirectoryFamenunProject()) return [3 /*break*/, 4];
                    defaultId = "my-first-app";
                ...
                case 1:
                    ...
                    projectQuestions.push({
                        type: "input",
                        name: "id",
                        message: "Id of the project (Ex. my-first-app) :\"",
                        default: defaultId,
                    });
                ...
                case 2:
                    ...
                    resolve(__assign(__assign({}, options), { data: {
                            ...
                            color: projectAnswers.color || "#0095f6",
                        } }));
                    _a.label = 3;
...
var handle = function (args) {
    (function () { return __awaiter(void 0, void 0, void 0, function () {
        var options, _a, error_1, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 9];
                case 2:
                    if (!!project_utils_1.isDirectoryFamenunProject()) return [3 /*break*/, 8];
                    _b.label = 3;
                case 3:
                    _b.trys.push([3, 6, , 7]);
                ...
                case 4:
                    options = _b.sent();
                    return [4 /*yield*/, project_utils_1.createProject(options)];
                case 5:
                    _b.sent();
                ...
                case 10:
                    ...
                    console.log(chalk_1.default.bgYellow.bold("HELP") +
                        chalk_1.default.yellow(" With '" + options.command + "' you can build your famenun app in current directory. This command should be executed in the directory where the f.app.json file lies"));
                    return [3 /*break*/, 13];
                case 11: return [4 /*yield*/, project_utils_1.buildProject(process.argv[3])];
                case 12:
                    _b.sent();
                    _b.label = 13;
                ...
                case 17:
                    error_2 = _b.sent();
                    console.log(chalk_1.default.yellow.bold(chalk_1.default.red(error_2)));
                    return [3 /*break*/, 18];
